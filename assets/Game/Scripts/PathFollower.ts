import { _decorator, Component, Vec3, tween, easing, Tween, director, Collider } from 'cc';
...
export class PathFollower extends Component {
    ...
    public get distanceToDestination(): number {
    ...
    public tempStop(duration: number): void {
        ...
        const busCtrl = this.node.getComponent(BusController);
    ...
    private _isPathBlocked(): boolean {
        ...
        const myBus = this.node.getComponent(BusController);
