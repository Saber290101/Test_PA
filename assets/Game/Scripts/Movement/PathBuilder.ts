...
import type { GateCheck } from '../Point/GateCheck';
...
export class PathBuilder {
    ...
    private static _appendWaypoints(gateCheck: GateCheck, points: Vec3[], wpIndices: number[], fromIdx: number, toIdx: number): void {
