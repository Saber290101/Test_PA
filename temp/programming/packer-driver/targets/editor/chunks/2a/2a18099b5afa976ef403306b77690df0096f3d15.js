    ...
    execute: function () {
      ...
      _export("default", Utility = ccclass(_class = class Utility extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        static DistanceV3(vec1, vec2) {
          let Distance = Math.sqrt(Math.pow(vec1.x - vec2.x, 2) + Math.pow(vec1.y - vec2.y, 2) + Math.pow(vec1.z - vec2.z, 2));
          return Distance;
        }
        ...
        static BetweenDegree(comVec, dirVec = new Vec2(0, 0)) {
          let angleDegree = 0;
        ...
        static convertUIWorldTo3DWorld(cameraUI, camera3D, worldPosUI, distanceFromCamera = 1) {
...
//# sourceMappingURL=2a18099b5afa976ef403306b77690df0096f3d15.js.map