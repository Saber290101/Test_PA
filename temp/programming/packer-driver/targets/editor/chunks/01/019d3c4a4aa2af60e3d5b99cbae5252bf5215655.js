System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Animation, BusController, GlobalEvent, EventManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, Gamecontroller;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Animation', 'CCBoolean']);
        ...
        pushToListChar() {
          ...
          this.map.children.forEach(generateDataNode => {
            generateDataNode.children.forEach(skModelNode => {
              const busController = skModelNode.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
                error: Error()
        ...
        checkCharCanMove() {
          this.scheduleOnce(() => {
            ...
            for (let i = this.listCharacter.length - 1; i >= 0; i--) {
              ...
              const busController = characterNode.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
                error: Error()
              }), BusController) : BusController);
...
//# sourceMappingURL=019d3c4a4aa2af60e3d5b99cbae5252bf5215655.js.map