System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "da6a5YIQp1P8ZGxJuCiFo0v", "super_html_playable", undefined);
      ...
      _export("super_html_playable", super_html_playable = class super_html_playable {
        ...
        */
        ...
        /**
         * 检查音频是否启用
         * channel : ironsource, applovin, etc.
         * @returns true nếu audio được bật, false nếu bị tắt
         */


        is_audio() {
          //@ts-ignore
          if (window.super_html && typeof window.super_html.is_audio === 'function') {
            //@ts-ignore
            return window.super_html.is_audio();
          } // Mặc định trả về true nếu không có super_html
...
//# sourceMappingURL=41c6dbbd46be1af2d4943f29101d25260c34c470.js.map