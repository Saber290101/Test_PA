System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Point, BusController, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, WayPoint;
      ...
      _export("WayPoint", WayPoint = (_dec = ccclass('WayPoint'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec(_class = (_class2 = class WayPoint extends Component {
        ...
        moveToNextWayPoint(characterNode) {
          ...
          for (let i = 0; i < this.listWayPoints.length; i++) {
            ...
            const point = this.listWayPoints[i].getComponent(_crd && Point === void 0 ? (_reportPossibleCrUseOfPoint({
              error: Error()
            }), Point) : Point);
            const busCtrl = characterNode.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
              error: Error()
...
//# sourceMappingURL=f064ff7d974df0ade3c554f5e81e7c90107416d6.js.map