      ...
      _export("ViewportChecker", ViewportChecker = class ViewportChecker {
        ...
        _isNodeOutOfViewport() {
          ...
          if (!ViewportChecker._mainCamera) {
            ...
            var rootNode = (_this$_node$scene = this._node.scene) == null || (_this$_node$scene = _this$_node$scene.getChildByName('Canvas')) == null ? void 0 : _this$_node$scene.getChildByName('Camera');
            if (rootNode) ViewportChecker._mainCamera = rootNode.getComponent(Camera);
          }

          if (!ViewportChecker._mainCamera) return false;

          var screenPos = ViewportChecker._mainCamera.worldToScreen(this._node.worldPosition);
...
//# sourceMappingURL=52c76eaf98eb44d4c03179ce48351d712e1d380e.js.map