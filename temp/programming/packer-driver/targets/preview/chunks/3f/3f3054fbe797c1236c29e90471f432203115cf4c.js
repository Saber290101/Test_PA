    ...
    execute: function () {
      ...
      _export("default", PlayableAdsController = (_dec = ccclass('PlayableAdsController'), _dec(_class = class PlayableAdsController extends Component {
        ...
        onLoad() {
          ...
          if (this.isBuild) console.warn = () => {}; //if (this.isBuild) console.error = () => { };
        ...
        openStore() {
          ...
          var linkStore = this.getLinkStore();
...
//# sourceMappingURL=3f3054fbe797c1236c29e90471f432203115cf4c.js.map