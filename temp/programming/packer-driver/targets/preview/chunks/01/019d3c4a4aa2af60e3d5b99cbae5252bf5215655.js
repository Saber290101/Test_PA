        ...
        pushToListChar() {
          ...
          this.map.children.forEach(generateDataNode => {
            generateDataNode.children.forEach(skModelNode => {
              var busController = skModelNode.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
                error: Error()
        ...
        checkCharCanMove() {
          this.scheduleOnce(() => {
            ...
            for (var i = this.listCharacter.length - 1; i >= 0; i--) {
              ...
              var busController = characterNode.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
                error: Error()
              }), BusController) : BusController);
