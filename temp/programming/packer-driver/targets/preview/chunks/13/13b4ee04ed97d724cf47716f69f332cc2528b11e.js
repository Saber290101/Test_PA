    ...
    execute: function () {
      ...
      _export("PassengerController", PassengerController = (_dec = ccclass('PassengerController'), _dec2 = property({
        ...
        applyColor() {
          ...
          for (var mr of renderers) {
            var passCount = mr.sharedMaterials.length; // Pass 0: body (mainColor)

            var mat0 = mr.getMaterialInstance(0);
            ...
            if (passCount >= 4) {
              var mat3 = mr.getMaterialInstance(3);
