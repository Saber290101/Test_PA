System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, tween, Enum, BusColor, ColorManager, StickmanAnimationController, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PassengerController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'tween', 'Enum']);
      ...
      _export("PassengerController", PassengerController = (_dec = ccclass('PassengerController'), _dec2 = property({
        ...
        boardBus(targetWorldPos, callback) {
          this.isBoarded = true;
          var target = targetWorldPos.clone();
...
//# sourceMappingURL=313504fb8926221265ee93272df5a47d89e1d07c.js.map