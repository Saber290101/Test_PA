    ...
    execute: function () {
      ...
      _export("PathFollower", PathFollower = (_dec = ccclass('PathFollower'), _dec(_class = class PathFollower extends Component {
        ...
        tempStop(duration) {
          ...
          var busCtrl = this.node.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
            error: Error()
        ...
        _isPathBlocked() {
          ...
          var myBus = this.node.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
            error: Error()
          }), BusController) : BusController);
          ...
          for (var other of this._cachedBuses) {
            ...
            var distCenterToCenter = Vec3.distance(myPos, otherPos);
            var minCenterDist = myHalfLen + otherHalfLen;
        ...
        _onCollisionEnter(event) {
          ...
          var otherBus = otherNode.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
            error: Error()
