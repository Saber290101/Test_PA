System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, easing, tween, Vec3, BusController, Gamecontroller, RaycastUtils, GateCheck, BusInitialMovement, _crd, SHAKE_INTENSITY;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      RaycastUtils = _unresolved_4.RaycastUtils;
    }, function (_unresolved_5) {
      GateCheck = _unresolved_5.GateCheck;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['easing', 'Node', 'tween', 'Tween', 'Vec3']);
      ...
      _export("BusInitialMovement", BusInitialMovement = class BusInitialMovement {
        ...
        startMove() {
          ...
          if (!result) {
            ...
            var gateCheck = result.collider.node.getComponent(_crd && GateCheck === void 0 ? (_reportPossibleCrUseOfGateCheck({
              error: Error()
            }), GateCheck) : GateCheck);
            var otherBus = result.collider.node.getComponent(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
              error: Error()
            ...
            if (otherBus) {
              ...
              var safeDist = Math.max(0, result.distance - this._bus.safeDistance);
              ...
              var _safeDist = Math.max(0, result.distance - this._bus.safeDistance);

              this._targetDist = _safeDist + this._bus.crashOffset;
        ...
        update(dt) {
          ...
          var remaining = this._targetDist - this._distMoved;
          var moveAmount = Math.min(this._bus.moveSpeed * dt, remaining);
        ...
        _shakeOnImpact(targetNode, impactDirection) {
          ...
          var origin = targetNode.worldPosition.clone();
          var dir = impactDirection.clone();
          dir.y = 0;
          dir.normalize();
          var offsets = [1, -0.6, 0.3, -0.15, 0];
          var durations = [0.05, 0.05, 0.04, 0.04, 0.03];
          var t = tween(targetNode);

          for (var i = 0; i < offsets.length; i++) {
            var pos = origin.clone().add(dir.clone().multiplyScalar(SHAKE_INTENSITY * offsets[i]));
            t = t.to(durations[i], {
              worldPosition: pos
            }, {
              easing: easing.quadOut
...
//# sourceMappingURL=2166930f4cfcf98eb3a5536c2bbd885b994842fb.js.map