System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, easing, Node, tween, Vec3, Gamecontroller, PathBuilder, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GateCheck;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      PathBuilder = _unresolved_3.PathBuilder;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GateCheck", GateCheck = (_dec = ccclass('GateCheck'), _dec2 = property(Node), _dec3 = property([Node]), _dec(_class = (_class2 = class GateCheck extends Component {
        ...
        moveCharTotarget(char) {
          var busCtrl = char.getComponent('BusController');
          var stopIdx = busCtrl ? this._resolveStopIdx(busCtrl) : -1;
          var lastIdx = busCtrl && stopIdx >= 0 ? stopIdx : this.wayPoints.length - 1;
          var {
            points,
            wpIndices
          ...
          if (busCtrl && stopIdx >= 0) {
            ...
            this._tweenAlongPath(char, points, () => {
              var bc = char.getComponent('BusController');
        ...
        moveWithOneWay(char) {
          ...
          var dis = Vec3.distance(char.worldPosition, this.endPos.worldPosition);
          var moveTime = dis / this.speed;
        ...
        _resolveStopIdx(busCtrl) {
          var stopPos = busCtrl.stopNode ? busCtrl.stopNode.worldPosition.clone() : busCtrl.busStop ? busCtrl.busStop.busStopWorldPos.lengthSqr() > 0.01 ? busCtrl.busStop.busStopWorldPos.clone() : busCtrl.busStop.node.worldPosition.clone() : null;
          if (!stopPos) return -1;
          ...
          var _loop = function _loop() {
            ...
            moveTween.call(() => {
              ...
              if (dir.lengthSqr() > 0.01) {
                ...
                var deltaAngle = targetAngle - currentEuler.y;
...
//# sourceMappingURL=a106d4400d940924b7231dd8dfba63f536c52455.js.map