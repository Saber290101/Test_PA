  ...
  return {
    ...
    execute: function () {
      ...
      _export("BusBoardingManager", BusBoardingManager = class BusBoardingManager {
        ...
        hideAllSeats() {
          for (var seat of this._bus.passengerSeats) {
        ...
        _boardNextPassenger() {
          ...
          var stop = this._bus.routeManager.currentBusStop || this._bus.busStop;
        ...
        _onBoardingComplete(isFull) {
          ...
          if (isFull || this._bus.currentPassengers >= this._bus.maxPassengers) {
            ...
            var nextStopIdx = this._bus.routeManager.findNextStopIdx(this._bus.routeManager.currentStopIdx);
        ...
        _activateSeat(seatIdx) {
          var seatNode = this._bus.passengerSeats[seatIdx];
          if (!seatNode) return;
          ...
          var animCtrl = seatNode.getComponent('StickmanAnimationController') || seatNode.addComponent('StickmanAnimationController');
...
//# sourceMappingURL=741818f48a7759f1780c8430f6a2591026c3e6f5.js.map