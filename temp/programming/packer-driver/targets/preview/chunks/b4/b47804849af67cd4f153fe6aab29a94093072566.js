    ...
    execute: function () {
      ...
      _export("PassengerSpawner", PassengerSpawner = (_dec = ccclass('PassengerSpawner'), _dec2 = property({
        ...
        spawnAll() {
          ...
          var stops = ((_director$getScene = director.getScene()) == null ? void 0 : _director$getScene.getComponentsInChildren(_crd && BusStop === void 0 ? (_reportPossibleCrUseOfBusStop({
            error: Error()
          }), BusStop) : BusStop)) || [];
        ...
        _generateGlobalColorGroups() {
          ...
          var groups = [];
          var buses = ((_director$getScene2 = director.getScene()) == null ? void 0 : _director$getScene2.getComponentsInChildren(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
            error: Error()
