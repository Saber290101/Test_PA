  ...
  return {
    ...
    execute: function () {
      ...
      _export("BusStop", BusStop = (_dec = ccclass('BusStop'), _dec2 = property({
        ...
        start() {
          var cm = (_crd && ColorManager === void 0 ? (_reportPossibleCrUseOfColorManager({
            error: Error()
        ...
        addPassenger(p) {
          var idx = this.passengers.length;
        ...
        _updateCountLabel() {
          if (this.countLabel) {
            var total = this.passengers.length;
        ...
        _alignPassenger(p, index) {
          ...
          var faceDir = new Vec3(-this.queueDirection.x, 0, -this.queueDirection.z);

          if (faceDir.lengthSqr() > 0.01) {
            var angle = Math.atan2(faceDir.x, faceDir.z) * (180 / Math.PI);
...
//# sourceMappingURL=f8d79fd168005976b05d27b2b8b8a7d622049f90.js.map