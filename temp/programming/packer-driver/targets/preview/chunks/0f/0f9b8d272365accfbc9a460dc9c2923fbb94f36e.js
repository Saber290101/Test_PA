System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, director, BusController, BusStop, Gamecontroller, PathBuilder, BusState, BusRouteManager, _crd, LEFT_LANE_START_IDX;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      BusState = _unresolved_6.BusState;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("BusRouteManager", BusRouteManager = class BusRouteManager {
        ...
        driveToExit() {
          ...
          var startIdx = this._currentStopIdx >= 0 ? this._currentStopIdx : this._stopIdx;
        ...
        driveToParking() {
          ...
          var slotIndex = this._bus.parkingManager.findFreeSlot();
          ...
          var slotPos = this._bus.parkingManager.getSlotPosition(slotIndex);

          var fromIdx = this._currentStopIdx >= 0 ? this._currentStopIdx : this._stopIdx;
        ...
        driveToNextStop(nextStopIdx) {
          this._bus.setState((_crd && BusState === void 0 ? (_reportPossibleCrUseOfBusState({
            error: Error()
          }), BusState) : BusState).RUNNING); // this._bus.setLipActive(true);
        ...
        handleDriveFromParking() {
          if (this._gateCheck && this._stopIdx >= 0) {
            var divertIdx = this._parkingDivertIdx;
            ...
            if (divertIdx >= 0) {
              var targetStopIdx = this.findAvailableStopIdx();
          ...
          var stopPos = this.getStopWorldPos();
        ...
        _moveTo(targetPos, onComplete) {
          var path = [this._bus.node.worldPosition.clone(), targetPos];
        ...
        findNextStopIdx(currentIdx) {
          ...
          for (var stop of this._allBusStops) {
            var wpIdx = this._getStopWaypointIndex(stop);
        ...
        _isStopOccupied(stopWpIdx) {
          ...
          for (var other of scene.getComponentsInChildren(_crd && BusController === void 0 ? (_reportPossibleCrUseOfBusController({
            error: Error()
            ...
            if (other.state === (_crd && BusState === void 0 ? (_reportPossibleCrUseOfBusState({
              ...
              var idx = other.routeManager.currentStopIdx >= 0 ? other.routeManager.currentStopIdx : other.routeManager.stopIdx;
          ...
          switch (this._bus.state) {
            ...
            case (_crd && BusState === void 0 ? (_reportPossibleCrUseOfBusState({
              ...
              if (this._bus.isParked) {
                var idx = this.findNextStopIdx(-1);
...
//# sourceMappingURL=0f9b8d272365accfbc9a460dc9c2923fbb94f36e.js.map