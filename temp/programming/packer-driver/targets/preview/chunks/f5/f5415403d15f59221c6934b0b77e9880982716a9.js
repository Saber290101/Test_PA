      ...
      _export("ColorManager", ColorManager = (_dec4 = ccclass('ColorManager'), _dec5 = property({
        ...
        _applyMaterialOrFallback(root, color, material) {
          ...
          if (material) {
            ...
            var _allRenderers = root.getComponentsInChildren(MeshRenderer);

            for (var _mr of _allRenderers) {
              // Bỏ qua các node chứa shadow cố định
...
//# sourceMappingURL=f5415403d15f59221c6934b0b77e9880982716a9.js.map